...
namespace AirFIT
{
    ...
    /// </summary>
    public sealed partial class ConsultarHistorico : Page
    {
        ...
        private void ConsultaM_Click(object sender, RoutedEventArgs e)
        {
           
            MyFrame.Navigate(typeof(ConsultarMapa));
        }

        private void ConsultaS_Click(object sender, RoutedEventArgs e)
        {
           
            MyFrame.Navigate(typeof(ConsultarSessao));
        }
    }
}
